...
import numpy as np
from whisper.utils import WriteTXT, WriteVTT, WriteSRT, WriteJSON, ResultWriter
...
async def transcribe(
    ...
    prompt: Annotated[str | None, Form()] = None,  # An optional text to guide the model's style or continue a previous audio segment. The prompt should match the audio language.
    ...
    res_dict = await async_transcribe(audio, TranscribeParams(
        model=model,
        prompt=prompt,
